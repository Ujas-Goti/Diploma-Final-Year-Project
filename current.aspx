<%@ Page Language="C#" AutoEventWireup="true" CodeFile="current.aspx.cs" Inherits="current" %>
...
<body class="body">
    <form id="form1" runat="server">
        ...
        <table align="center">
            <tr>
                <td align="center">
                    <asp:Label ID="Label1" runat="server" Text="Active Students" Font-Names="Cambria" ForeColor="White" Font-Size="Large"></asp:Label>
                    <br />
                    <br />
                </td>
            </tr>
