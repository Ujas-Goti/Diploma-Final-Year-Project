...
<body class="body">
    <form id="form1" runat="server" class="auto-style1">
        ...
        <asp:Panel ID="Panel3" runat="server" Visible="False">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" Display="Dynamic" ErrorMessage="RequiredFieldValidator" Font-Overline="False" Font-Size="Small" ForeColor="Red">*Reqiured Field</asp:RequiredFieldValidator>
            <br />
            <br />
            Confirm Password : <asp:TextBox ID="TextBox2" Height="25px" Width="200px" TextMode="Password" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" Display="Dynamic" ErrorMessage="RequiredFieldValidator" Font-Overline="False" Font-Size="Small" ForeColor="Red">*Reqiured Field</asp:RequiredFieldValidator>
