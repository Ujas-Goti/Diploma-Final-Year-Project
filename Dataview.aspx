    ...
    <form id="form1" runat="server">
       <nav><div class="navbar">
        ...
        <table align="center">
            ...
            <asp:GridView ID="GridView1"  runat="server" CellPadding="4" Height="50px" Width="850px" ForeColor="Black" PageSize="20" HorizontalAlign="Center"  BackColor="#333" BorderColor="#333333"   BorderWidth="1px" CellSpacing="2" Font-Size="XX-Small">
